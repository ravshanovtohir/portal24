  ...
  async update(id: number, data: UpdateCategoryDto) {
    ...
    await this.prisma.category.update({
      ...
      data: {
        ...
        title_uz: data?.title_uz ?? categoryExists?.name_en,
        title_ru: data?.title_ru ?? categoryExists?.name_en,
        title_en: data?.title_en ?? categoryExists?.name_en,
        seo_title_uz: data?.seo_title_uz ?? categoryExists?.name_en,
        seo_title_ru: data?.seo_title_ru ?? categoryExists?.name_en,
        seo_title_en: data?.seo_title_en ?? categoryExists?.name_en,
        seo_description_uz: data?.seo_description_uz ?? categoryExists?.name_en,
        seo_description_ru: data?.seo_description_ru ?? categoryExists?.name_en,
        seo_description_en: data?.seo_description_en ?? categoryExists?.name_en,
